 ...
 *
 * Code for this segment adapted from
...
public class DBHelper extends SQLiteOpenHelper implements DatabaseInterface {
    ...
    private static final String DB_PATH = "/data/data/com.example.andrew.statbible/databases/";
    ...
    /*
     * Mine, not from cited source
     */
    public DatabaseResults select(String query) {
        if (myDataBase != null) {
            DatabaseResults results;
            Cursor resultSet = myDataBase.rawQuery("select " + query, null);
            results = new DBResults(resultSet);
            return results;
        } else {
            return null;
        }
